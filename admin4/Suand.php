...
if (isset($_POST['sbm'])) { // Kiểm tra xem form đã submit chưa
    ...
    $Sodienthoai = $_POST['Sodienthoai'];
        ...
        $sql = "UPDATE nguoidung SET tennd='$Tennd',matkhau='$Matkhau',email='$Email',phanquyen='$Phanquyen',sodienthoai='$Sodienthoai'
...
?>
<?Php $idnguoidung = $_GET["idnguoidung"];
...
<div class="section-menu-left">
    ...
    <fieldset class="name">
        <div class="body-title">Tên người dùng <span class="tf-color-1">*</span></div>
        <input class="flex-grow" type="text" name="Tennd" tabindex="0" value="<?php echo $row["tennd"] ?>" aria-required="true" required="">
        <input type="hidden" class="form-control" name="Idnguoidung" value="<?php echo $row["idnguoidung"] ?>">
    </fieldset>
    
    <fieldset class="name">
    <div class="body-title">Mật khẩu <span class="tf-color-1">*</span></div>
    <input class="flex-grow" id="password" type="password" name="Matkhau" tabindex="0" value="<?php echo $row["matkhau"] ?>" aria-required="true" required="">
    <button type="button" id="togglePassword" class="btn btn-secondary">Hiện</button>
</fieldset>
    ...
    <fieldset class="name">
        ...
        <input class="flex-grow" type="email" name="Email" tabindex="0" value="<?php echo $row["email"] ?>" aria-required="true" required="">
    </fieldset>
    ...
    <div class="select">
        <select name="Phanquyen" required="">
            <option value="Người dùng" <?php echo (isset($row['phanquyen']) && $row['phanquyen'] == 'Người dùng') ? 'selected' : ''; ?>>Người dùng</option>
            <option value="Admin" <?php echo (isset($row['phanquyen']) && $row['phanquyen'] == 'Admin') ? 'selected' : ''; ?>>Admin</option>
        </select>
    </div>
</fieldset>
    ...
    <fieldset class="name">
        ...
        <input class="flex-grow"  type="text" name="Sodienthoai" tabindex="0" value="<?php echo $row["sodienthoai"] ?>" aria-required="true" required="">
    </fieldset>
...
<script>
    document.getElementById('togglePassword').addEventListener('click', function () {
        ...
        this.textContent = passwordType === 'password' ? 'Hiện' : 'Ẩn';
    });
</script>