                        ...
                        <div class="main-content-inner">
                            <div class="main-content-wrap">
                                ...
                                <div class="flex items-center justify-between gap10 flex-wrap">
                                        ...
                                        <a class="tf-button style-1 w208" href="Themnd.php"><i
                                                class="icon-plus"></i>Thêm người dùng</a>
                                    </div>
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="name"><?php echo $row['tennd'] ?></td>
                                                            ...
                                                            <td>
                                                                <div class="list-icon-function">
                                                                    <a href="Suand.php?idnguoidung=<?php echo $row["idnguoidung"] ?>">
                                                                        <div class="item edit">
