...
if (!empty($tukhoa)) {
    ...
    $sql .= " WHERE tenkm LIKE '%$tukhoa%' or idkm like '%$tukhoa%' ";
}
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                ?>
                                                    ...
                                                    <td><?php echo $row['idkm'] ?></td>
                                                        ...
                                                        <td><?php echo $row['phan_tram_giam'] ?>%</td>
                                                        
                                                        <td>
                                                        <div class="list-icon-function">
                                                                <a href="Suakm.php?idkm=<?php echo $row["idkm"] ?>">
                                                                    <div class="item edit">
                                                                        <i class="icon-edit-3"></i>
                                                                    </div>
                                                                </a>
                                                                <a onclick="return confirm('Bạn có thật sự muốn xóa không ?');" href="Xoakm.php?idkm=<?php echo $row["idkm"] ?>"onclick="myDel()">
