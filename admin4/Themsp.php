...
$sql = "INSERT INTO sanpham (tensp, gia, hinh, iddanhmuc, mota) VALUES ('$tensp', '$gia', '$hinh', '$iddanhmuc', '$mota')";
...
<div class="section-menu-left">
                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                                    ...
                                    <div class="wg-box">
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="text" placeholder="Nhập tên sản phẩm"
                                                name="tensp" tabindex="0" value="" aria-required="true" required="">
                                        ...
                                        <div class="gap22 cols">
                                            <fieldset class="category">
                                                ...
                                                <div class="select">
                                                    <select class="" name="iddm">
                                                    <option selected="selected" value="">Chọn loại</option>
                                                        <?php $sql="select iddm,tendanhmuc from danhmuc ";
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Nhập giá thông thường"
                                                    name="gia" tabindex="0" value="VNĐ" aria-required="true"
                                                    required="">
                                            </fieldset>
                      ...
                      <div class="col-sm-10">
                        <input type="file" class="form-control"  placeholder="Chọn tiệp" name="hinh" required>
                      </div>
                    </div>
                                        </fieldset>
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                <div class="body-title mb-10">Mô tả <span
                                                        class="tf-color-1">*</span></div>
                                                <input class="mb-10" type="text" placeholder="Nhập mô tả sản phẩm"
                                                    name="mota" tabindex="0" value="" aria-required="true"
                                                    required="">
                                            </fieldset>
                                            ...
                                            <button name="sbm" class="tf-button w-full" type="submit">Thêm sản phẩm</button>
                                        </div>
