...
if (isset($_POST['sbm'])) { // Kiểm tra xem form đã submit chưa
    ...
    $sql="INSERT INTO  nguoidung (tennd,matkhau,email,phanquyen,sodienthoai) 
    VALUES ('$tennd','$matkhau','$email','$phanquyen','$sodienthoai') ";
...
<div class="section-menu-left">
    ...
    <fieldset class="name">
        ...
        <input class="flex-grow" type="text" name="tennd" tabindex="0" value="" aria-required="true" required="">
    </fieldset>
    
    <fieldset class="name">
    <div class="body-title">Mật khẩu <span class="tf-color-1">*</span></div>
    <input class="flex-grow" id="password" type="password" name="matkhau" tabindex="0" value="" aria-required="true" required="">
    ...
    <fieldset class="name">
        ...
        <input class="flex-grow" type="email" name="email" tabindex="0" value="" aria-required="true" required="">
    </fieldset>
    ...
    <fieldset class="name">
        ...
        <input class="flex-grow" type="text" name="sodienthoai" tabindex="0" value="" aria-required="true" required="">
    </fieldset>
