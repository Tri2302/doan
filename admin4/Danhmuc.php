...
if (!empty($tukhoa)) {
    ...
    $sql .= " WHERE tendanhmuc LIKE '%$tukhoa%' ";
}
                            ...
                            <div class="main-content-wrap">
                                ...
                                <div class="wg-box">
                                    <div class="flex items-center justify-between gap10 flex-wrap">
                                        ...
                                        <a class="tf-button style-1 w208" href="ThemDM.php"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="list-icon-function">
                                                            <a href="Suadm.php?iddm=<?php echo $row["iddm"] ?>">
                                                                <div class="item edit">
                                                                    <i class="icon-edit-3"></i>
                                                                </div>
                                                            </a>
                                                            <a onclick="return confirm('Bạn có thật sự muốn xóa không ?');" href="Xoadm.php?iddm=<?php echo $row["iddm"] ?>"onclick="myDel()">
