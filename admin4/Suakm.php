...
if (isset($_POST['sbm'])) {
    ...
    $phan_tram_giam = $_POST['phan_tram_giam'];
        $sql = "UPDATE khuyenmai SET tenkm='$tenkm',ngaybd='$ngaybd',ngaykt='$ngaykt',phan_tram_giam='$phan_tram_giam'
        WHERE idkm= '$Idkm ' " ;
...
$query="select idkm,tenkm,ngaybd,ngaykt,phan_tram_giam from khuyenmai
 WHERE  idkm =".$idkm;
                                    ...
                                    <form class="form-new-product form-style-1" method="POST" action="#">
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Nhập tên khuyến mãi" name="tenkm"
                                                tabindex="0" value="<?php echo $row["tenkm"] ?>" aria-required="true" required="">
                                                <input type="hidden" class="form-control" name="Idkm" value="<?php echo $row["idkm"] ?>">
                                        </fieldset>
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="date" 
                                                name="ngaybd" tabindex="0" value="<?php echo $row["ngaybd"] ?>" aria-required="true"
                                                required="">
                                        </fieldset>
                                        <fieldset class="name">
                                            <div class="body-title">Ngày bắt đầu <span class="tf-color-1">*</span></div>
                                            <input class="flex-grow" type="date" 
                                                name="ngaykt" tabindex="0" value="<?php echo $row["ngaykt"] ?>" aria-required="true"
                                                required="">
                                        </fieldset>
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Nhập số phần trăm" name="phan_tram_giam"
                                                tabindex="0" value="<?php echo $row["phan_tram_giam"] ?>" aria-required="true" required="">
                                        </fieldset>
